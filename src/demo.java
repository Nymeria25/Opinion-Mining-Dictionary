...
public class demo {
	...
	public static void runDemos() throws Exception {
		...
		RoWordNet rown = RoWordNet.deserializeFromFile("wordnet-resources\\RoWordNet.data");
 ...
 */               
	 ...
	 * @param RoWN
	 *            the synset hierarchy
	 * @param textCorpus_FilePath
	 *            the path where the corpus used for computing the IC is located
	 *            on disk
	 * @throws Exception
	 */
	public static void demo_SimilarityMetrics(RoWordNet RoWN, String textCorpus_FilePath) 
                throws Exception {
		boolean allowAllRelations = true;
        ...
        public static void demo_Lavinia(RoWordNet RoWN) 
                throws Exception {
            
            boolean allowAllRelations = true;

		Literal l1 = new Literal("neted");
		Literal l2 = new Literal("viteaz");
		String result1 = RoWN.getSynsetsFromLiteral(l1).get(0).getDomain();
                String result2 = RoWN.getSynsetsFromLiteral(l2).get(0).getDomain();
                System.out.println("neted -> " + result1);
                System.out.println("viteaz -> " + result2);
